...
import { changeLocalStorageDarkModeLightModeEffects as changeLocalStorageDarkmodeLifhtmodeEffects } from './effects/cange-localstorage-darkmode-lightmode.effects';
import { toggleDarkModeUI } from './effects/change-ui-from-darkmode-lightmode.effects';
...
function* toggleDarkModeSaga(newDarkModeState) {
  yield call(changeLocalStorageDarkmodeLifhtmodeEffects, newDarkModeState);
  yield call(toggleDarkModeUI, newDarkModeState);
}
