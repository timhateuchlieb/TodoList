import { p as proxyCustomElement, H, h } from './p-e500cf36.js';
import { d as defineCustomElement$2 } from './p-3094fd05.js';
...
const TodoList$1 = /*@__PURE__*/ proxyCustomElement(class TodoList extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
    ...
    static get style() { return TodoListStyle0; }
}, [1, "todo-list", {
        "tasks": [32],
        "darkMode": [32],
        "newTaskText": [32]
...
function defineCustomElement$1() {
    ...
    const components = ["todo-list", "todo-item"];
    components.forEach(tagName => { switch (tagName) {
        case "todo-list":
            if (!customElements.get(tagName)) {
                customElements.define(tagName, TodoList$1);
            }
            break;
        case "todo-item":
            if (!customElements.get(tagName)) {
...
const TodoList = TodoList$1;
const defineCustomElement = defineCustomElement$1;

export { TodoList, defineCustomElement };
